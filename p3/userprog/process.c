...
start_process (void *file_name_)
{
  ...
  spte_init(&thread_current()->suppl_page_table);
              ...
              uint32_t read_bytes, uint32_t zero_bytes, bool writable) 
{
  ...
  bool success = page_lazy_load(file, ofs, upage, read_bytes, zero_bytes, writable, type_file);
  return success;
}
